class BooksRepository:
    ...
    def update_book(self, book_id: int, title: str, author: str, year: int, total_pages: int, genre: str):
        book = self.get_book(book_id=book_id)
        if book:
            book.update({"title": title, "author": author, "year": year, "total_pages": total_pages, "genre": genre})
