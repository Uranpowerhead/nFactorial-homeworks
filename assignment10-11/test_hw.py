...
class TestExercise(unittest.TestCase):
    ...
    def test_compose(self):
        ...
        self.assertEqual(new_func(3), 7)
        self.assertEqual(new_func(0), 1)
    ...
    def test_factorial_reduce(self):
        self.assertEqual(hw.factorial_reduce(3), None)
        self.assertEqual(hw.factorial_reduce(4), None)
        self.assertEqual(hw.factorial_reduce(1), None)
